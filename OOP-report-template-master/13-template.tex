...
\subsection{Enrico Ancarani}
\begin{itemize}
	\item \textbf{Utilizzo di Optional}: Utilizzato in vari punti, un esempio è: 
	\item \textbf{Utilizzo di Stream}: Utilizzato in vari punti, un esempio è: 
	\item \textbf{Utilizzo di Lambda expressions}: Utilizzato nella classe LabyrinthImpl: 
\end{itemize}
